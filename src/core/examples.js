...
export const EXAMPLES = {
  ...
  mech2d: {
    ...
    objects: [
      ...
      { id: 'block', type: 'body', x: 52, y: 38, w: 11, h: 8, rotate: 30, label: 'm', color: '#0f9d8f' },
      { id: 'G', type: 'force', x: 52, y: 38, angle: -90, mag: 17, label: 'G=mg', color: '#dc2626' },
      { id: 'N', type: 'force', x: 52, y: 38, angle: 120, mag: 15, label: 'N', color: '#2f6df6', hidden: true },
      { id: 'f', type: 'force', x: 52, y: 38, angle: 30, mag: 9, label: 'f', color: '#e08b1a', hidden: true },
      { id: 'G1', type: 'force', x: 52, y: 38, angle: 210, mag: 8.5, label: 'G sinθ', color: '#dc2626', dash: true, hidden: true },
      { id: 'G2', type: 'force', x: 52, y: 38, angle: -60, mag: 14.7, label: 'G cosθ', color: '#dc2626', dash: true, hidden: true },
